              ...
              <div class="card-body">
                <div class="row">
                      ...
                      <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                        <div class="carousel-inner bg-light rounded position-relative">
                          ...
                          <div class="carousel-item active">
                            <img src="<?= $producto->cover ?>" class="d-block w-100" alt="Product images"/>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <ul>
                      <li class="mb-2"> <?= $producto->description ?></li>
                      <li class="mb-2"><?= $producto->slug ?></li>
                      <li class="mb-2"><?= $producto->features ?></li>
                      <li class="mb-2">Marca: <?= $producto->brand->name ?></li>
                    </ul>
                    <div class="mb-3 row">
